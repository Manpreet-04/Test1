...
    return(name = "customer_name, account_number")};
<Form.Group controlId="customer_name"><Form.Label>customer_name</Form.Label><Form.Control
                type="text"
                name="customer_name"
                placeholder="Enter your name"
                onChange={this.handleInputChange}
              /></Form.Group> <Form.Group controlId="account_number"><Form.Label>account_number</Form.Label><Form.Control
                type="text"
                name="account_number"
...
    const { selectedType } = this.state;
    return (<div> <divclassName="account"> <Button
            variant="primary"
            className={`${
...
            Show_balance </Button>m</Button>
            </div>  <div>
          {selectedType === 'withdraw' || selectedType === 'deposit' ? (</div></div>
    );
  }
}
